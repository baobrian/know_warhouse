...
if __name__ == '__main__':
    path='C:\Users\Administrator\Desktop\liushi\data20190701\data\\'
    ...
    os.chdir('C:\Users\Administrator\Desktop\liushi\data20190701\\')
    # result_cohort.loc['row_sum']=result_cohort.apply(lambda x:x.sum())
    result_cohort.to_excel('setl_total.xlsx',header=True)
